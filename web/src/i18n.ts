...
export const AUTH: Record<Language, AuthStrings> = {
  en: {
    ...
    notifyOff: "We won't email you about replies to this invitation.",
    notifyTurnOff: "Turn off",
  ...
  uk: {
    ...
    notifyOff: "Ми не надсилатимемо листів про відповіді на це запрошення.",
    notifyTurnOff: "Вимкнути",
    notifyTurnOn: "Увімкнути",
    signOut: "Вийти",
